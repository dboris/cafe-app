...
let githubLink = "https://github.com/Update GitHome in build.fsx/CafeApp"

// Specify more information about your project
let info =
  [ "project-name", "CafeApp"
    "project-author", "dboris"
    "project-summary", "Project has no summmary; update build.fsx"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/CafeApp" ]
